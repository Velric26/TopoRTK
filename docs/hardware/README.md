...
| Unicore UM980 on BDRTK-980 | Base and rover RTK engine | [Module, carrier, and connected receiver](unicore-um980/README.md) | 2026-09-14 SiK bench: both receivers delivered CRC-valid COM2 RTCM; one carrier's COM1 output fault remains open, so that board stays a COM2-only Rover |
| Holybro SiK 1 W 915 MHz pair | RTCM correction link | [Radio documentation](../radio.md) | 2026-09-14 bench: the production SiK RTCM path delivered about 94% of submitted frames with every delivered frame forwarded and zero output faults; range, outdoor RTK and compliance pending |
