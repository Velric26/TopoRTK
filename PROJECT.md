...
**2026-09-14 update:** 0.11.0 implements the Debug OTA workflow and paired update notices in source. Build/host/browser checks pass; USB installation and actual OTA/rollback acceptance are pending. SiK correction recovery requires a fresh Base session and Rover rejoin after an update. The user asked to finish the software step and stop; no unit was flashed. See the [operator guide](docs/ota-operator-guide.md) and [evidence](tests/2026-09-14-ota/README.md).
